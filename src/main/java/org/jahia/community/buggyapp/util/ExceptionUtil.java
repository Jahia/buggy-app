...
public class ExceptionUtil {
     ...
     *
     * @param exception
     * @return	complete stack trace of the Exception and it's associated message. Besides that it also returns all of
     * the parent exception chain and their stack trace.
     */
